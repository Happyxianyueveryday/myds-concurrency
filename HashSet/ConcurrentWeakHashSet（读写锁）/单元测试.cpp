...
int main(void)
{
	ConcurrentWeakHashSet<Hashable> hashset("fair");
	srand(8);
	vector<Hashable> dev;
	for(int i=0;i<5;i++)
	{
	...
	ConcurrentWeakHashSet<Hashable> hashset2(dev, "read_first", 32);
	cout<<"hashset2 = "<<endl;
	...
	ConcurrentWeakHashSet<Hashable> hashset5(data, "write_first", 16);

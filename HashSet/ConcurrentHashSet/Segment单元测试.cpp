...
int main(void)
{
	...
	Segment<Hashable> hashset2(dev);
	cout<<"hashset2 = "<<endl;
	cout<<hashset2.toString()<<endl;
	
	cout<<"--------------------------------------------"<<endl;
	
	Segment<Hashable> hashset3;
	hashset3=hashset;
	cout<<"hashset3 = "<<endl;
	...
	Segment<Hashable> hashset4=hashset3;
	...
	Segment<Hashable> hashset5(data);
	...
	cout<<"--------------------------------------------"<<endl;
	Segment<Hashable> hashset6(move(hashset5));
	cout<<hashset6.length()<<endl;
	Segment<Hashable> hashset7=Segment<Hashable>()=move(hashset6);

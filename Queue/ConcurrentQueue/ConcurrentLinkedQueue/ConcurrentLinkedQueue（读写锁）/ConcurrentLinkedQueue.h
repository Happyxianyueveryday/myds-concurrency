#ifndef CONCURRENTLINKEDSTACK_H 
#define CONCURRENTLINKEDSTACK_H
...
class ConcurrentLinkedQueue: public Queue<T>
{
    ...
    ConcurrentLinkedQueue<T>(string mode);
...
template<typename T> 
ConcurrentLinkedQueue<T>::ConcurrentLinkedQueue(string _mode)
{
...
template<typename T>
void ConcurrentLinkedQueue<T>::set_lock(string lockmode)
{
